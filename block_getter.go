...
func NewBlockGetter(workerNumber int, bhm block_height_manager.BlockHeightManager) *BlockGetter {
	cli := rpc.NewRpcClient(conf.Solana.RpcEndpoint)
	return &BlockGetter{workerNumber: workerNumber, cli: cli, bhm: bhm}
}
